...
`func NewVectordbProfileInfo(name string, provider VectordbProviders, endpoint VectordbEndpoint, createdBy string, createdAt int64, lastUpdate int64, ) *VectordbProfileInfo`
